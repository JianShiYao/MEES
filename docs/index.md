...
1. 阅读[v0.2 基线评审记录](11_Process_Management/v0.2基线评审记录.md)，确认 Conditional Go 的问题和整改边界。
2. 复核候选提交 `181857a` 的 75 / 75 链接、唯一责任、角色命名和 MkDocs 严格构建证据。
3. 使用[v0.2 核心过程基线检查表](14_Checklists/v0.2核心过程基线检查表.md)复核关闭 M1–M4。
4. 独立评审人补充签署并形成最终 `Go` 后，基线化 v0.2 并进入 v0.3 详细映射。
