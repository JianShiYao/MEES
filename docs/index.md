...
1. 阅读[v0.3.0 标准映射建设计划](00_Introduction/04_v0.3建设计划.md)，按 WP0–WP6 推进工作。
2. 复核[v0.3 标准映射总览](11_Process_Management/v0.3标准映射总览.md)中的官方来源、适用范围和统一字段，批准 V3-G0。
3. 以 ASPICE / ISO/IEC 33020 为主骨架，并行建设 ISO 26262、IEC 62443 和 ISO 9001 专项映射。
4. 汇总跨标准控制、证据复用和 `GAP-V03-*` 差距，形成 v0.4 模板输入。
