...
- 完成度：50%
- 当前门禁：v0.5.1 内部收口基线已发布；JianShi 已批准 V6-G0，v0.6 进入 WP1，优先关闭 F4/F5/F6。Agent、Obsidian MCP 和 BMS 参考项目仍受 V6-G1–G5 控制。证据为工具 `P` + 数据 `S`，不构成产品批准、真实独立评估、标准符合性、认证或能力等级证明
